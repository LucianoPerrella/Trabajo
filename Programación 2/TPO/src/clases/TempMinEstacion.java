...
//	• Decidir si las temperaturas registradas se produjeron en orden creciente
	protected float[] listaTemperaturas;
	...
	public float[] getListaTemperaturas() {
	...
	public void establecerTempMin(int indice, float elem) {
		try {
			...
			System.out.println("Estás tratando de ingresar un elemento en un índice que no existe.");
		}
